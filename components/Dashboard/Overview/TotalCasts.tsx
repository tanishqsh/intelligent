...
import { useCastsChartData } from '../hooks/useCastsChartData';
import CastsMiniChart from '../CastsMiniChart';

export default function TotalCasts() {
	...
	const getStatsByDuration = (duration: string) => {
		switch (duration) {
			case Duration.HOURS_24:
				return {
					mentions: stats.casts_24h,
					prevMentions: stats.casts_prev_24h,
					mentionsPercentageChange: stats.casts_percentage_change_24h,
				};
			case Duration.DAYS_7:
				return {
					mentions: stats.casts_7d,
					prevMentions: stats.casts_prev_7d,
					mentionsPercentageChange: stats.casts_percentage_change_7d,
				};
			case Duration.DAYS_30:
				return {
					mentions: stats.casts_30d,
					prevMentions: stats.casts_prev_30d,
					mentionsPercentageChange: stats.casts_percentage_change_30d,
				};
			case Duration.DAYS_180:
				return {
					mentions: stats.casts_180d,
					prevMentions: stats.casts_prev_180d,
					mentionsPercentageChange: stats.casts_percentage_change_180d,
				};
			default:
				return null;
		}
		...
		>
			<div className="h-full items-center justify-between">
				...
				<AnimatePresence mode="wait">
					...
					>
						<CastsMiniChart data={castChartData} />
					</motion.div>
				</AnimatePresence>
			</div>
		</motion.div>
