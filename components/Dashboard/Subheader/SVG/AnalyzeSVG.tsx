	...
	return (
		<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path
				...
				strokeLinejoin="round"
			></path>
			<path d="M14.25 4.75L17.25 6.75V9.25L14.25 11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<path d="M17.5 8H19.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
		</svg>
	);
};
