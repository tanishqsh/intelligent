const FingerprintSVG = () => {
	return (
		<svg className="w-6 h-6 md:w-12 md:h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			></path>
			<path d="M4.74999 12.25C4.5 7.5 8.13399 4.75 12 4.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<path d="M12 8.75C13.7949 8.75 15.25 10 15.25 12.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<path d="M15.25 14.75V16.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
			<path
